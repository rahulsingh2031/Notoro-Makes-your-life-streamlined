...
const NoteSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'significance': PropertySchema(
      id: 4,
      name: r'significance',
      type: IsarType.byte,
      enumMap: _NotesignificanceEnumValueMap,
    ),
...
void _noteSerialize(
  ...
  writer.writeByte(offsets[4], object.significance.index);
...
Note _noteDeserialize(
  ...
  final object = Note(
    ...
    significance:
        _NotesignificanceValueEnumMap[reader.readByteOrNull(offsets[4])] ??
...
P _noteDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_NotesignificanceValueEnumMap[reader.readByteOrNull(offset)] ??
          Significance.importance) as P;
    case 5:
      return (reader.readString(offset)) as P;
    default:
...
const _NotesignificanceEnumValueMap = {
  'importance': 0,
  'moderate': 1,
  'inessential': 2,
};
const _NotesignificanceValueEnumMap = {
  0: Significance.importance,
  1: Significance.moderate,
  2: Significance.inessential,
};
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> significanceEqualTo(
      Significance value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'significance',
        value: value,
      ));
    });
  }

  QueryBuilder<Note, Note, QAfterFilterCondition> significanceGreaterThan(
    Significance value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> significanceLessThan(
    Significance value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> significanceBetween(
    Significance lower,
    Significance upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortBySignificance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'significance', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortBySignificanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'significance', Sort.desc);
    });
  }
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenBySignificance() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'significance', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenBySignificanceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'significance', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctBySignificance() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'significance');
    });
  }
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, Significance, QQueryOperations> significanceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'significance');
    });
  }
